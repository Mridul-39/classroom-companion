...
- studentName: first or full name of the student (must be on the roster)
...
Output: {"studentName":"riya","title":"Essay on Photosynthesis","description":"500 words","dueDate":"<3 days from now ISO>"}

Input: can you assign "create a telegram bot" to Mridul Goyal, deadline 6 hours from now
Output: {"studentName":"Mridul Goyal","title":"Create a telegram bot","description":"create a telegram bot and share the github repo link","dueDate":"<6h from now ISO>"}

Input: assign mridul an essay of 1000 words, deadline is 2 days
Output: {"studentName":"mridul","title":"Essay of 1000 words","description":"Write an essay of 1000 words","dueDate":"<2 days from now ISO>"}

Input: assign mridul an essay of 1000 words
Output: {"studentName":"mridul","title":"Essay of 1000 words","description":"Write an essay of 1000 words","dueDate":null}
...
Output:`;
    ...
    if (parsed) {
      const studentName = parsed.studentName ? String(parsed.studentName).trim() : null;
      ...
      if (studentName || dueDate) {
        return { studentName, title, description, dueDate };
      }
    }
  } catch (error) {
